...
<html lang="pt-br">
    ...
    <body >
        <%
            ...
            List<Paciente> listaPaciente = (ArrayList) request.getAttribute("listaPaciente");
                                ...
                                <div class="form-group" style="margin: 60px 0px">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <input type="text" name="nomePac" placeholder="Digite o nome do paciente" class="form-control">
                                            <input type="hidden" name="acao" value="consPaciente">
